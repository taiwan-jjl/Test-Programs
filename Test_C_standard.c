...
Type: C11, single thread, random number, standard output, time
compile:
...
printf("Type: C11, single thread, random number, standard output, time\n");
printf("printf a random number integer %i\n",rand());
